...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_dir', action='store',type=str,default='../test_02/')  # ToDo: reset to: default='../test/'
    ...
    predictions = predict_labels(ecg_leads,ecg_labels,fs,ecg_names,model_name=args.model_name, is_binary_classifier=False)  # remove binary classifier argument
